...
const reservedRoutes = new Set(['/manage/dashboard', '/manage/categories', '/manage/tags', '/manage/settings', '/manage/assets', '/manage/taxonomy'])
const isEditor = computed(() => /^\/manage\/[^/]+$/.test(route.path) && !reservedRoutes.has(route.path))
const showBackToTop = computed(() => ['/manage/dashboard', '/manage/settings', '/manage/assets'].includes(route.path))
